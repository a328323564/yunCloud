...
$(function() {
	...
	/* $("#submit_btn").click(function() {
		...
		if(uname.length > 0 && pwd.length >0 && verifyCode.length>0){
			//ajax 把账号密码验证码提交到后台去
			$.post("${ctx}/syslogin.gzsxt",{uname:uname,pwd:pwd,verifyCode:verifyCode},function(data){
				if(data.code == 0){
...
<body class="signin">
	<div class="signinpanel">
		<div class="row">
			...
			<div class="col-sm-5">
				<form id="loginForm" method="post" action="${ctx}/syslogin.gzsxt">
